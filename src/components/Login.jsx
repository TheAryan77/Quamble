...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(response.data.message); // Show success message as an alert
    } catch (error) {
      if (error.response && error.response.status === 401) {
        alert("User does not exist! Redirecting to sign-up page...");
        setTimeout(() => navigate('/signup'), 1000);
      } else {
        const errorMessage = error.response?.data?.message || "Something went wrong!";
        setResponse(errorMessage);
        alert(errorMessage); // Show error message as an alert
      }
    }
  };
  ...
  return (
    <>
      <div class="min-h-screen bg-gray-200 flex flex-col justify-center py-12 -mt-10 sm:px-6 lg:px-8">
